...
g = sns.FacetGrid(all, col="type", col_wrap=2, height=4, aspect=1, margin_titles=True, despine=False)
...
g.map(sns.regplot, "x", "features_range", order=3, truncate=False, scatter=False, ci=95, color='dodgerblue')
...
plt.savefig(f"figures/endemic_minerals/linear_regression_2_polynomial_sns.jpeg", dpi=300, format='jpeg')
